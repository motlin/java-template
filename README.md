...
This template was derived from common patterns in:

- [liftwizard](https://github.com/motlin/liftwizard) (primary reference)
- [klass](https://github.com/motlin/klass)
- [klass-database-testutil](https://github.com/motlin/klass-database-testutil)
- [liftwizard-reladomo-utc-infinity-timestamp](https://github.com/motlin/liftwizard-reladomo-utc-infinity-timestamp)
